...
<ChapterTitle number="07" subtitle="從重新執行的角度理解問題根源">
Re-render
<br/>
為什麼會造成效能問題？
</ChapterTitle>
...
即使只有一小塊資料改變，整個 Component 還是重新執行，這樣的代價累積起來就可能會變很大。
...
**提醒：**雖然 Re-render 會造成效能問題，但 Re-render 本身不是壞事也沒有錯哦！

因為 React 就是透過 Re-render 來讓畫面能夠即時更新來反映資料變化。

重點是要避免不必要的 Re-render。
-->
